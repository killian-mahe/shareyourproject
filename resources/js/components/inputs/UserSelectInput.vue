<template>
    <div class="w-full relative" v-click-outside="onClickOutside">
        ...
        <div v-if="selectedUsers.length > 0" class="w-full border border-gray-200 rounded-b-md flex flex-wrap p-2 bg-cultured-300">
            <div v-for="user in selectedUsers" :key="user.id+'_selected'" class="flex items-center px-2 py-1 border border-gray-400 bg-cultured-100 rounded-lg mr-2 mb-2">
