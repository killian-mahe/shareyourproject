...
<div class="w-full h-auto bg-cultured-400 flex justify-center py-6">
    <div class="justify-center flex-row hidden sm:block w-1/4 md:w-1/4 lg:w-1/5">
        <div class="w-full h-120 bg-cultured-100 rounded-lg shadow-md"></div>
    </div>
    <div class="flex-col w-full mx-2 sm:mx-5 sm:w-3/5 md:w-2/3 lg:w-1/2">
        <div class="w-full h-auto mb-6 shadow flex-col">
            ...
            <div class="bg-red-300 text-right font-semibold font-sans text-2xl mr-1/7 my-4">{{$project->name}}</div>
            <div class="">{{$project->owner->username}}</div>
            <div class="">{{$project->created_at}}</div>
            <div class="w-full h-auto bg-yellow-300">Tags</div>
            <div class="w-full h-auto bg-indigo-300">badges</div>
        </div>
    ...
    <div class="justify-center flex-row hidden lg:w-1/5 lg:block">
        <div class="w-full h-120 bg-cultured-100 rounded-lg shadow-md"></div>
    </div>
</div>
@endsection
